  ...
  return (
    <div className="flex min-h-[100dvh] flex-col items-center justify-center px-6 text-center">
      <motion.p
        ...
        className="text-[22vw] leading-none"
      >
        ∞
      </motion.p>
      <p className="serif mt-2 text-4xl sm:text-6xl">HAPPY BIRTHDAY</p>
      ...
      <div className="mt-10 max-w-md space-y-4 text-lg text-mute">
        ...
        <p>
          With respect, from {student.name}
          <br />
          {student.section} · {student.roll}
          <br />
          {student.programme}
        </p>
        <p className="eq text-sm tracking-[0.25em]">{teacher.date}</p>
      </div>
      <ActionButton
